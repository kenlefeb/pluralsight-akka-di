...
namespace MovieStreaming.Actors
{
    public class PlaybackStatisticsActor : ReceiveActor
    {
            ...
            return new OneForOneStrategy(
                exception =>
                {
                    ...
                    if (exception is SimulatedTerribleMovieException)
                    {
                        ...
                        _logger.Warning(
							"PlaybackStatisticsActor supervisor strategy resuming child due to terrible movie {Movie}", 
        ...
        {
            _logger.Debug("PlaybackStatisticsActor PreRestart because {Reason}", reason);
        ...
        {
            _logger.Debug("PlaybackStatisticsActor PostRestart because {Reason}", reason);
