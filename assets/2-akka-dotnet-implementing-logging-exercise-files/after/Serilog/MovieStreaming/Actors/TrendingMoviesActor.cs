...
namespace MovieStreaming.Actors
{
    public class TrendingMoviesActor : ReceiveActor
    {
        ...
        private void HandleIncrementMessage(IncrementPlayCountMessage message)
        {
            ...
            _logger.Info("TrendingMoviesActor most popular movie trending now is {Movie}", topMovie);
        }
        ...
        {
            _logger.Debug("TrendingMovieActor PreRestart because {Reason}", reason);
        ...
        {
            _logger.Debug("TrendingMovieActor PostRestart because {Reason}", reason);
